...
- `omp_get_initial_device()` returns device where host code is running
...
:::: {.column width="70%"}
::: {.fragment}
Specify slice to copy:

- C++: `array[<begin>:<size>]`
- Fortran: `array(<begin>:<end>)`
:::
::::
:::: {.column width="30%"}
::: {.callout-tip .fragment}
Shortcut: `array[:<length>]` or `array(:<end>)`
:::
::::
:::::
...
- [OpenMP specification](https://www.openmp.org/spec-html/5.2/openmp.html)
